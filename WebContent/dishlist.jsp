        ...
        <div class="mbr-box__container mbr-section__container container">
            <div class="mbr-box mbr-box--stretched"><div class="mbr-box__magnet mbr-box__magnet--center-center">
               ...
               <table style="display: inline-block;">
												<tr>
													<th align="center" style="text-align: center"><u>Dishes</u></th>
												</tr>
														
														
												<c:forEach var="list_dish" items="${list_dish}">
													<tr>
													
														<td align="left">${list_dish.dname}</td>
														
														<td> <input type="hidden" name="index" value="${list_dish.dname}"/> 
														
														<div class="mbr-buttons btn-inverse mbr-buttons--center"><input type="submit" name="action" value="View Recipe" class="mbr-buttons__btn btn btn-lg btn-success"/>
															</td>
													</tr>
												</c:forEach>
											</table>
                    ...
                    <div class="mbr-buttons btn-inverse mbr-buttons--center"><a class="mbr-buttons__btn btn btn-lg animated fadeInUp delay btn-success" href="ex200welcome.html">Check Work Out</a> <a class="mbr-buttons__btn btn btn-lg btn-default animated fadeInUp delay" href="page2.jsp">Back</a></div>
                </div></div>
            </div></div>
        </div>
