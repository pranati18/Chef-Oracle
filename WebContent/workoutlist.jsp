...
<section class="engine"></section><section class="mbr-box mbr-section mbr-section--relative mbr-section--fixed-size mbr-section--full-height mbr-section--bg-adapted mbr-parallax-background mbr-after-navbar" id="header4-16" style="background-image: url(assets/images/bg3.jpg);">
    <div class="mbr-box__magnet mbr-box__magnet--sm-padding mbr-box__magnet--center-center">
      ...
      <p class="mbr-hero__subtext">
               ...
               <table style="display: inline-block;" style="text-align: center">
												<tr>
													<th align="center" style=" text-align: center"><u>Workout List</u></th>
												</tr>

												<c:forEach var="list_workout" items="${list_workout}">
													<tr>
													
														<td align="left">${list_workout.wname}</td>
														
														<td> <input type="hidden" name="workoutname" value="${list_workout.wname}"/> 
														<div class="mbr-buttons btn-inverse mbr-buttons--center"><input type="submit" name="action" value="View Workout" class="mbr-buttons__btn btn btn-lg btn-success"/>
															</td>
													</tr>
												</c:forEach>
											</table>
